...
export class RecoveryRegistered extends ethereum.Event {
  get params(): RecoveryRegistered__Params {
    return new RecoveryRegistered__Params(this);
  }
}

export class RecoveryRegistered__Params {
  _event: RecoveryRegistered;

  constructor(event: RecoveryRegistered) {
    this._event = event;
  }
...
export class WalletRecovered extends ethereum.Event {
  get params(): WalletRecovered__Params {
    return new WalletRecovered__Params(this);
  }
}

export class WalletRecovered__Params {
  _event: WalletRecovered;

  constructor(event: WalletRecovered) {
    this._event = event;
  }
...
export class ETHPrivate__stateResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class ETHPrivate extends ethereum.SmartContract {
  static bind(address: Address): ETHPrivate {
    return new ETHPrivate("ETHPrivate", address);
  }
  ...
  getCommitmentOfSender(): string {
    let result = super.call(
      "getCommitmentOfSender",
      "getCommitmentOfSender():(string)",
      [],
    );
  ...
  try_getCommitmentOfSender(): ethereum.CallResult<string> {
    let result = super.tryCall(
      "getCommitmentOfSender",
      "getCommitmentOfSender():(string)",
      [],
  ...
  recoverWallet(
    ...
    let result = super.call(
      "recoverWallet",
      "recoverWallet(bytes,uint256[],address):(bool)",
      [
        ethereum.Value.fromBytes(proofs),
        ethereum.Value.fromUnsignedBigIntArray(_input),
  ...
  registerForRecovery(
    _featureVectorHash: BigInt,
    _hashOfPersonalInfoHash: BigInt,
    _commitment: string,
  ): boolean {
    let result = super.call(
      "registerForRecovery",
      "registerForRecovery(uint256,uint256,string):(bool)",
      [
        ethereum.Value.fromUnsignedBigInt(_featureVectorHash),
        ethereum.Value.fromUnsignedBigInt(_hashOfPersonalInfoHash),
        ethereum.Value.fromString(_commitment),
      ],
    );
  ...
  state(): ETHPrivate__stateResult {
    ...
    return new ETHPrivate__stateResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_state(): ethereum.CallResult<ETHPrivate__stateResult> {
    let result = super.tryCall(
      "state",
      "state():(address,address,address,address,address,uint32)",
      [],
...
export class RegisterForRecoveryCall extends ethereum.Call {
  get inputs(): RegisterForRecoveryCall__Inputs {
    return new RegisterForRecoveryCall__Inputs(this);
  }

  get outputs(): RegisterForRecoveryCall__Outputs {
    return new RegisterForRecoveryCall__Outputs(this);
  }
}

export class RegisterForRecoveryCall__Inputs {
  _call: RegisterForRecoveryCall;

  constructor(call: RegisterForRecoveryCall) {
    this._call = call;
  }

  get _featureVectorHash(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _hashOfPersonalInfoHash(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _commitment(): string {
    return this._call.inputValues[2].value.toString();
  }
}

export class RegisterForRecoveryCall__Outputs {
  _call: RegisterForRecoveryCall;
...
export class WithdrawCallParamsStruct extends ethereum.Tuple {
  ...
  get faceVectorHash(): BigInt {
    return this[8].toBigInt();
  }

  get reedSolomonProof(): Bytes {
    return this[9].toBytes();
  }

  get publicSignals(): Array<BigInt> {
